...
Shaders = function (gl, vertexShader, fragmentShader) {
  if (!gl) throw "GL Context not set.";
...
Shaders.prototype.AttachShader = function () {
  ...
  this.shaderProgram.isSkyBox = this.gl.getUniformLocation(this.shaderProgram, "uIsSkyBox");
  this.shaderProgram.drawColourMap = this.gl.getUniformLocation(this.shaderProgram, "uDrawColourMap");
  this.shaderProgram.colourMapColour = this.gl.getUniformLocation(this.shaderProgram, "uColourMapColour");
}
